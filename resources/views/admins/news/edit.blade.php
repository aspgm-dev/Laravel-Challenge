                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.news.update', $news->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" name="image_name[]" multiple>
                        </div>
                        <div class="row">
                        @if(!$news->images()->first())
                        @else
                        @foreach($news->images()->get() as $item)
                        <img src="{{ asset('storage/'. $item->image_name) }}" class="d-block" height="100px">
                        @endforeach
                        @endif
                    </div>
